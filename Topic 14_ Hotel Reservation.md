...
● **_Nhu cầu Tìm kiếm:_** Hàng triệu người dùng truy cập cùng lúc để xem
...
● **_Nhu cầu Đặt phòng:_** Khi người dùng quyết định thanh toán, tính toàn
...
○ _Yêu cầu kỹ thuật:_ Hệ thống phải trả về kết quả gần như tức thời.
...
○ _Yêu cầu kỹ thuật:_ Sử dụng cơ chế Pessimistic Locking trên SQL để
...
hủy.
○ _Yêu cầu kỹ thuật:_ Sử dụng RDBMS (SQL) và cơ chế Transaction
...
○ _Yêu cầu kỹ thuật:_ Dữ liệu đánh giá (bao gồm nội dung văn bản,
...
tiền, Phí phạt hủy).
○ _Yêu cầu kỹ thuật:_ Xây dựng bảng Financial Ledger (Sổ cái
...
○ _Yêu cầu kỹ thuật:_ Sử dụng **SQL Window Functions** để
...
○ _Yêu cầu kỹ thuật:_ Triển khai **SQL Trigger** để tự động kiểm
